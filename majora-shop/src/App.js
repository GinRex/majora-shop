  ...
  render() {
    ...
    return (
      <div className={classes.root}>
        ...
        >
          <Toolbar disableGutters={!this.state.open} style={{minHeight: '75px', backgroundColor:'#2d92eacf'}} >
            <IconButton
              color="inherit"
        ...
        >
          ...
          <Divider />
          <List>
            <ListItem button key={'Home'} onClick={() => this.props.history.push("/home")}>
              <ListItemIcon><HomeIcon /></ListItemIcon>
              <ListItemText primary={'Home'} />
            </ListItem>
            <ListItem button key={'List Game'} onClick={() => this.props.history.push("/list-game")}>
